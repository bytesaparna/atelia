...
import { queryLatestAuctionBidders, queryLatestAuctionBiddersForProvidedTokens, queryLatestAuctionState } from "./queries"
import { z } from "zod"
...
export const auctionRouter = createTRPCRouter({
    ...
    queryLatestAuctionBiddersForProvidedTokens : publicProcedure.input(z.object({ tokens: z.array(z.number()) })).query(({ input, ctx }) => queryLatestAuctionBiddersForProvidedTokens(input.tokens, ctx.rpcProvider)()),
