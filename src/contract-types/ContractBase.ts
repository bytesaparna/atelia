...
export interface ContractBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ContractBase extends BaseContract {
  connect(runner?: ContractRunner | null): ContractBase;
  waitForDeployment(): Promise<this>;

  interface: ContractBaseInterface;
